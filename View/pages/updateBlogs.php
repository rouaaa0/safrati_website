  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
        ...
        <span class="ms-1 font-weight-bold text-white">SAFRATI</span>
      </a>
    </div>
...
<body>
    ...
    ?>
        ...
        <form method="POST" action="updateBlogs.php" id="formr" >
            <table>
                <tr>
        ...
        myform.addEventListener('submit', function(e) {
            ...
            if (titreinput.value === '') {
                let ltitre = document.getElementById('titre');
                ltitre.innerHTML = "le champs prenom est vide . ";
                ltitre.style.color = 'red';
                e.preventDefault();
            } else if (!(regex.test(titreinput.value))) {
                let ltitre = document.getElementById('titre');
                ltitre.innerHTML = "le prenom doit comporter des lettres,et tirets seulements.";
                ltitre.style.color = 'red';
                e.preventDefault();
            }
            if (contenuinput.value === '') {
                let nameer = document.getElementById('contenu');
                lcontenu.innerHTML = "le champs nom est vide . ";
                lcontenu.style.color = 'red';
                e.preventDefault();
            } else if (!(regex.test(contenuinput.value))) {
                let lcontenu = document.getElementById('contenu');
                lcontenu.innerHTML = "le nom doit comporter des lettres,et tirets seulements.";
                lcontenu.style.color = 'red';
                e.preventDefault();
            }
