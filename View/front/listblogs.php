			...
			<div class="container">
				<div class="row">
					<div class="col d-flex flex-row">
						<div class="phone">+216 25 481 446</div>
						<div class="social">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <div class="thumbnail">
                            ...
                            <div class="images">
                                <img src="images/gallery_3.jpg" alt="blog-img">
                            ...
                            <div class="caption">
                                <div class="blog-txt">
                                    ...
                                    <form method="post" action="like.php">
                                        ...
                                        <button type="submit" class="btn <?= $blogLikeController->userLikedBlog(1, $blog['idBlog']) ? 'green' : ''; ?>"><i class="fa fa-thumbs-up"></i></button>
                                        <?= $blog['likes']; ?>
                                    </form>
                                    ...
                                    <form method="post" action="like.php">
                                        ...
                                        <button type="submit" class="btn <?= $blogLikeController->userDislikedBlog(1, $blog['idBlog']) ? 'red' : ''; ?>"><i class="fa fa-thumbs-down"></i></button>
                                        <?= $blog['dislikes']; ?>
                                    </form>
                                    ...
                                    <a href="showblog.php?idBlog=<?= $blog['idBlog']; ?>">VIEW COMMENTS</a>
                                </div><!--/.blog-txt-->
                            </div><!--/.caption-->
                        </div><!--/.thumbnail-->
