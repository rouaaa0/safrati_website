...
<h1><strong>- Liste des Dates -</strong></h1>

<!-- Buttons -->
<div style="text-align: center; margin-bottom: 20px;">
    <button class="button" onclick="location.href='listVols.php';">Go to List Vols</button>
    <button class="button" onclick="location.href='addDate.php';">Add Date</button>
</div>

<!-- Form to view calendar -->
<form method="post" action="">
    <div style="text-align: center; margin-bottom: 20px;">
        <button class="button" type="submit" name="view_calendar">Voir le calendrier</button>
    </div>
</form>
...
<table border="1" align="center">
    ...
    foreach ($dates as $date) { ?>
        <tr>
            ...
            <td>
                <a href="deleteDate.php?date=<?= $date['date']; ?>" class="button">Supprimer</a> <!-- Link to delete the date -->
            </td>
        </tr>
    <?php } ?>
</table>
