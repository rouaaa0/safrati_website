  ...
  <div class="container-fluid py-1 px-3">
    <nav aria-label="breadcrumb">
      ...
      <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
        ...
        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Vols</li>
      </ol>
      <h6 class="font-weight-bolder mb-0">-List fo Flights-</h6>
...
<style>
        ...
        /* Align center for Update and Delete buttons */
        .crud-buttons {
            text-align: center;
        }
    </style>
...
<div class="button-container">
    <!-- Add Button -->
    <button class="button" onclick="location.href='addVols.php';">Add</button>
    <!-- Sort Button -->
    <button class="button" onclick="location.href='triVols.php';">Sort by Date</button>
    <!-- Stats Button -->
    <button class="button" onclick="location.href='statsVols.php';">Stats</button>
    <!-- Calendar Button -->
    <button class="button" onclick="location.href='calendarDate.php';">Calendar</button>
    <!-- Search Button -->
    <button class="button" onclick="location.href='recherchVols.php';">Search</button>
...
<table border="1" align="center" width="70%">
    <tr>
        ...
        <th>Destination</th>
        <th>Date_depart</th>
        <th colspan="2">Actions</th> <!-- Colspan to merge two cells for Update and Delete -->
    </tr>
    ...
    <?php foreach ($tab as $vol) { ?>
        <tr>
            ...
            <td class="crud-buttons">
                <a href="deleteVols.php?id=<?= $vol['id_vols']; ?>" class="button">Delete</a>
            </td>
        </tr>
    <?php } ?>
</table>
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="../Vols/listVols.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="../accomodation.html">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="../pack/afficherPack.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="../claim.html">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Flights table</h6>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">ID flight</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Compagnie</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Depart</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Destination</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Date Depart</th>
