...
<div class="super_container">
					...
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						...
						<div class="main_nav_container ml-auto">
							<ul class="main_nav_list">
								...
								<li class="main_nav_item"><a href="flights.php">flights</a></li>
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="images/R.jpg"></div>
		<div class="home_content">
			<div class="home_title" style="color: black;">Add your trip</div>
		</div>
	</div>
    ...
    <div class="container" id="container">
		<div class="form-container sign-up">
		  <form action="" method="post"  onsubmit="return verif_Up()">
			...
			<button class="button" onclick="location.href='calandre.php';">Calendar</button>
					...
					<div class="footer_nav_container d-flex flex-row align-items-center justify-content-lg-end">
						<div class="footer_nav">
							<ul class="footer_nav_list">
								...
								<li class="footer_nav_item"><a href="flights.php">offers</a></li>
