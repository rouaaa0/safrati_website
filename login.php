<?php
include_once 'C:/xampp/htdocs/projetwissem/UserManagment/Dashboard/Controller/UserC.php';
include_once 'C:/xampp/htdocs/projetwissem/UserManagment/Dashboard/Model/User.php';
session_start(); 
            ...
            if(password_verify($_POST['password'],$userexist['password'])==false){
              var_dump($userexist);
                ...
                if($_SESSION['role']=="Client"){                 
                    ...
                    header("Location:/projetwissem/UserManagment/Dashboard/View/back/material-dashboard-master/pages/User/AfficherUtilisateurs.php");   
                    exit; 
                }
            }
        }
